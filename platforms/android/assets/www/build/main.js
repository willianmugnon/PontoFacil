...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/geisson/Área de Trabalho/PontoFacil/src/app/app.html"*/'<ion-menu [content]="content" id="menu-perfil">\n  <ion-header class="cabecalho">\n    <ion-toolbar color="primary" class="usuario">\n      <img src="{{perfil.foto}}" class="imagem" (click)="abrirPerfil()">\n      <div class="text">Ponto Fácil</div>\n      <div class="text">Willian_mugnon@hotmail.com</div>\n    </ion-toolbar>\n  </ion-header>\n\n\n\n\n</ion-menu>\n<!-- Desativar deslize para voltar, porque é mau UX para combinar STGB com menus laterais -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/home/geisson/Área de Trabalho/PontoFacil/src/app/app.html"*/
        }),
